...
from .views import WorkshopListView, WorkshopDetailView, WorkshopMyView, WorkshopCreateView, WorkshopUpdateView, WorkshopDeleteView, WorkshopExportCsvView, invite_user_to_workshop
...
urlpatterns = [
    ...
    path('<int:workshop_id>/invite-user', invite_user_to_workshop, name='invite-user-to-workshop'),
